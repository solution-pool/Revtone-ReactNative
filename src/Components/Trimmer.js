...
const MAXIMUM_TRIM_DURATION = 6000000000000
    ...
    return (
      <View style={styles.root}>
        <ScrollView
          ...
          style={[styles.horizontalScrollView, {transform: [{scaleX: 0.9}]}]}
          horizontal
          ...
          <View
            ...
            <View
              style={[styles.handleHead, {backgroundColor: tintColor}]}
            />
            <View
              style={[styles.handleTail, {backgroundColor: tintColor}]}
            />
            <View
              style={[styles.handleBottomHead, {backgroundColor: tintColor}]}
            />
          </View>
          <View
            style={[
            ...
            <View style={[styles.selection, {backgroundColor: '#973719'}]} />
          </View>
          <View
